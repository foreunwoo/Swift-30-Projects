...
class HomeVC: UIViewController {
    ...
    let originLanguageButton = UIButton(frame: CGRect(x: 0, y: 0, width: 0, height: 20)).then {
        $0.layer.borderWidth = 0.5
    ...
    let translatedLanguageButton = UIButton(frame: CGRect(x: 0, y: 0, width: 20, height: 20)).then {
        $0.layer.borderWidth = 0.5
        $0.layer.cornerRadius = 12
    ...
    func makeConstraints() {
        ...
        view.addSubview(originLanguageButton)
        
        view.addSubview(translationButton)
        
        view.addSubview(translatedTextView)
        view.addSubview(translatedLanguageButton)
        
        originLanguageButton.snp.makeConstraints {
            $0.width.greaterThanOrEqualTo(90)
            
            $0.left.equalTo(view.snp.left).offset(10)
            $0.bottom.equalTo(originTextView.snp.top).offset(-10)
        }
        originTextView.snp.makeConstraints {
            $0.height.equalTo(150)
            
            $0.left.equalTo(originLanguageButton)
        ...
        translatedLanguageButton.snp.makeConstraints {
            $0.width.greaterThanOrEqualTo(90)
        ...
        translatedTextView.snp.makeConstraints {
            ...
            $0.top.equalTo(translatedLanguageButton.snp.bottom).offset(10)
